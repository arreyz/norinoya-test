...
export const NEWS_UPDATES: NewsUpdate[] = [
  ...
  },
  {
    ...
    title: '🏷️ Stok Komik Bekas Review @konotasi Baru Saja Di-upload!',
    content: '🏷️ STOK BEKAS REVIEW MASUK: Baru saja diupload 3 unit komik bekas curated review @konotasi.sukasuka termasuk Naruto Bind Up Ed. 1 kondisi Tier A. Langsung check out sebelum disabet pemburu lainnya!',
    category: 'promo',
