...
export default function AboutSection() {
  return (
    ...
    >
      ...
      {/* Ads Placeholder */}
      <div className="w-full bg-neutral-50 dark:bg-neutral-950/40 border border-dashed border-neutral-300 dark:border-neutral-800 rounded-xl p-4 text-center space-y-1">
        <span className="text-xs font-mono uppercase tracking-wider text-neutral-400 dark:text-neutral-500 block leading-[16px]">📢 SPONSORED ADSENSE</span>
        <div className="text-sm text-neutral-500 dark:text-neutral-450 font-sans leading-[20px]">
